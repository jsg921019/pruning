...
class Trainer:
    ...
    def train(self, model, dataloaders, criterion, optimizer, lr_scheduler, max_epoch, patience, l1_weight, save_name='best', sub_dir=None):        
                        ...
                        if phase == 'train':
                            ...
                            for m in model.modules():
                                if isinstance(m, nn.BatchNorm2d):
                                    m.weight.grad.data.add_(l1_weight * torch.sign(m.weight.data))
